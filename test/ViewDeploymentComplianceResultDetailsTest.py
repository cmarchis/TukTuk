...
class ViewDeploymentComplianceResultDetailsTest(unittest.TestCase):
    def setUp(self):
        ...
        DataSetup().grab_random_resource_id()
        DataSetup().grab_random_deployment_id()

        DataSetup().grab_resource_data_by_template_id("4936")
        DataSetup().grab_deployment_data_by_template_id("4936")
        # get Template
        # templates_json = MockApiUtils().grab_templates_json()
        ...
        #
        # # get Deployment
        # deployment_list = ListUtils().grab_list_of_deployment_info(templates_json)
        ...
        #
        # # get Compliance
        # compliance_json = MockApiUtils().grab_compliance_json_for_resource_id(self.random_resource_id)
