...
DEPLOYMENT_INFO_SELECTOR = 'div.grommetux-box--pad-small div.grommetux-box--pad-medium:first-child'
POLICIES_BAR_LIST_SELECTOR = 'div.grommetux-box--pad-small div[class="grommetux-box grommetux-box--direction-row grommetux-box--responsive grommetux-box--pad-none"]'
NOTIFICATION_CONTAINER_SELECTOR = 'section.grommetux-section'
RESOURCES_LIST_SELECTOR = 'ul.grommetux-list ul li'


class DeploymentDetailsPage(WebdriverBase):
    """
    ...
    def create_list_of_dictionary_of_deployment_info(self, number_of_policies):
        """
    ...
    def create_list_of_policies_dimensions_bar(self):
        ...
        print 'list: ', len(policies_bar_list)
        return_list = []
    ...
    def get_container_number(self):
        ...
        container_list = self.locate_elements_by_css_selector(
            "div[class = 'grommetux-box grommetux-box--direction-column grommetux-box--responsive grommetux-box--pad-vertical-small'] > *")
    ...
    def wait_until_notification_disappear(self):
        ...
        i = 0
        number = 0
        while (number != 1) and (i < 20):
            number = self.get_container_number()
            print 'wait'
            time.sleep(3)
            i += 1
